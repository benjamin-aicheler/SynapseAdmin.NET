...
public class SynapseAdminGateway(AuthenticatedHomeserverSynapse synapse) : MatrixGatewayBase(synapse)
{
    ...
    {
        // Re-implement extension: /_synapse/admin/v3/users
    ...
    {
        // Re-implement extension: /_synapse/admin/v2/users/{userId}
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/send_server_notice
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/statistics/users/media
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/users/{userId}/memberships
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/rooms
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/rooms/{roomId}
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/room/{roomId}/media
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/statistics/database/rooms
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/rooms/{roomId}/messages
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/federation/destinations
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/event_reports
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/registration_tokens/new
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/server_version
    ...
    {
        // Re-implement extension: /_synapse/admin/v1/media/{serverName}/{mediaId}
    ...
    {
        // Re-implement extension (re-uses the above)
