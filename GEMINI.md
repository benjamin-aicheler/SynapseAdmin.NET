...
- **Status:** Active Development; basic auth, dashboard, room/user management (including creation, memberships, and media), room message history, event reports, registration tokens, federation destinations, server notices, multi-language support (EN, DE, FR), and MudBlazor UI are implemented.
